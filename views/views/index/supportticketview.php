...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1"/>
        ...
        <link type="text/css" rel="stylesheet" href="<?= SITE_PUBLIC_URL ?>css/tavikportal.css" />
 <link type="text/css" rel="stylesheet" href="<?= SITE_URL ?>public/css/daterangepicker.css" />
        ...
        <script type="text/javascript" src="<?= SITE_URL ?>public/js/front_dashboard.js"></script>  
        ...
        <script type="text/javascript" src="<?= SITE_URL ?>public/css/jquery-ui/jquery-ui.min.js"></script><script type="text/javascript" src="<?= SITE_URL ?>public/js/daterange/moment.min.js"></script>
        <script type="text/javascript" src="<?= SITE_URL ?>public/js/daterange/daterangepicker.js"></script>
...
<link type="text/css" rel="stylesheet" href="<?= SITE_URL ?>public/css/support_popup.css" />
    </head>
    <body>
...
<style>
    ...
    .litebox_input{
        background-image: url('<?php echo SITE_PUBLIC_URL; ?>images/magnifying-search-lenses-tool.png');
    ...
    <table style="width: 100%; height: 60px;" >
        <tr>
            <td style="width: 150px; vertical-align: middle;">
                <a href=""><img src="<?php echo SITE_PUBLIC_URL; ?>images/IncipioLogo-209x53.png" class="logo-sales"></a></td>
            <td style="width: 2px;text-align: center; vertical-align: middle;"><div class="vertical-line-sales"></div></td>
            <td style="vertical-align: middle;"><span class="head-text-sales"> Sample Request Portal</span></td>

<?php if (Session::get('requester_display_name')) { ?>
                <td style="vertical-align: middle;">
                    ...
                    <div class="head-customer-text"> 
                        ...
                        <img   style="cursor: pointer;margin-bottom: 0px;" id="sort-view" src="<?php echo SITE_PUBLIC_URL; ?>images/support_new.png" /> 
                        </span>
                    <span class="vertical-line-second"></span>
                    <div class="dropdown" style="margin-left: 5px;">
                            <a href="#" style="text-decoration: none; color: #fff;"><?= Session::get('requester_display_name') ?> 
    ...
    <table  style="margin-top: 22px; background-color: #fff; width: 100%; padding-bottom: 3px;">
        <tr>
            <td width="25%">
                ...
                <table><tr>
                        <td><img class="header-icons" src="<?= SITE_URL ?>public/images/back.png" /></td>
                        <td style="padding-top: 0px; padding-left: 5px;">Back to Dashboard</td>
                    </tr></table>

            </a>
            </td>
            <td width="50%" style="text-align: center;"> <?php include_once DOC_ROOT_PATH . '/modules/common/views/messenger.php'; ?>
            </td>
...
<!--            <td width="15%" >
            ...
            <td style="width: 140px;">      
                <div style="width: 100%; margin-top: 3%; background-color: #fff;">
                            <a href="<?php echo SITE_URL; ?>" class="createnewrequest"  title="Add New">Create New  <img src="<?= SITE_URL ?>public/images/plus.png" style="max-width: 30px; vertical-align: text-top;"/></a>
...
<!--<div class="thumbnail-img-div" style="display: inline-block;padding:20px;">
             <div class="sub-heading">ALL COMMENTS </div><div class="thumbnail-img-a-div">
             </div>
                    <div class="thumbnail-img-div-inner" style="">
                        <div class="thumbnail-img-outer-div"> <img class="thumbnail-img" src="<?= SITE_PUBLIC_URL ?>images/file_type_thumbs/image_icon.png"></div>
                            <p style="background-color:#333;padding:5px;margin-bottom: 0px;">
<a target="_blank" href="<?= SITE_URL_MODULE ?>index/downloadJiraAttachments?file=aHR0cHM6Ly9pbmNpcGlvLmF0bGFzc2lhbi5uZXQvc2VjdXJlL2F0dGFjaG1lbnQvMzAyMTEvMTU0MzU3NzMzNS1Eb24lMjd0K3Njcm9sbCt0aGUrdGlja2V0K3JlcXVlc3QrZm9ybSt3aXRoK2JhY2srZ3JvdW5kK2Rhc2hib2FyZC4uanBn" title="1543577335-Don%27t+scroll+the+ticket+request+form+with+back+ground+dashboard..jpg" style="color:#fff;">Download</a></p>
</div><div style="text-align:left;font-weight:bold; padding:3px;color:#000;" title="1543577335-Don%27t+scroll+the+ticket+request+form+with+back+ground+dashboard..jpg"> 1543577335...+dashboard.<span style="float:right;">189.42 KB</span> </div>
</div>-->
 <?php
                    if (!empty($ticketsData['fields']['attachment'])) {
                        ...
                        foreach ($ticketsData['fields']['attachment'] as $attachment) {
                            ...
                            print_r(HtmlHelper::getTicketAttachmentPreview($attachment['content'], $attachment['size'], $attachment['id'], $ticketsData['key'], 'VIEW'));
                        }
                    } else {
...
//                            $dateeee = Utility::getPSTCurrentTime($comment['updated'])->format('m/d/Y h:i:s A');
                        ...
                        <div id="add_comment_div">
                            <form id="comment_submit_form" method="POST" action="<?= SITE_URL ?>support/index/addcomment" novalidate="novalidate"  >
   ...
   <iframe id="support_iframe"  src="<?=SITE_URL.'support/index/support?dashboard_type=Requester-Dashboard';?>" width="100%" style="font-family: Roboto Condensed !important;height:98%; margin: auto;border:0;" ></iframe>
</div>   
