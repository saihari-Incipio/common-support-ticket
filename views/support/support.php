...
<style>
    ...
    src: url(<?= SITE_URL ?>views/css/fonts/Roboto_Condensed/Roboto-Regular.ttf);
}
...
<img style="vertical-align:middle; margin-right: 15px;cursor: pointer;" class="Fileupload" id="fileupload-attachments" src="' + SITE_URL + 'views/images/plus_icon.png" onclick="triggerUploadAction(' + 1 + ');" /> <label for="input-file-1" style="cursor: pointer;">FILE ATTACHMENTS UP TO 100MB</label>\n\
...
<div id="support-container-div" class="support-container-div" >
    ...
    <form id="support-project-quotation" name="support-project-quotation"  target="_parent" action="<?= SITE_URL ?>support/supportsubmit" method="POST" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off" >
        <div class="">
...
<input type="hidden" class="request" id="proj_jira_code" name="proj_jira_code" value="<?=$_REQUEST['proj_jira_code'];?>" required/>
    ...
    margin-bottom: 5px;"> Attachment(s) :  </p>
                    ...
                    <div class="div-file" id="div-file-1">
                        <label for="input-file-1" style="cursor: pointer;">
                            <img style="vertical-align:middle; margin-right: 15px;" class="Fileupload" id="fileupload-attachments" src="<?= SITE_URL ?>views/images/plus_icon.png" /> FILE ATTACHMENTS UP TO 100MB 
                        </label>
